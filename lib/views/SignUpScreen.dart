import 'package:easy/views/verify.dart';
...
String email,isim,soyisim;
    void addData() async{
      ...
      if(jsonString=='Başarıyla kayıt oldunuz!!'){
        ...
        var urlDogrula = jsonData['url'];
        sendMail(_firstNameTextController.text, _lastNameTextController.text, _emailTextController.text,urlDogrula);
        preferences.setString("urldogrula", urlDogrula);
        ...
        myToast("E-postanızı doğrulayın.");
  ...
  sendMail(String isim, String soyisim,String mail,String urlDogrula) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    ...
    final message = Message()
      ...
      ..recipients.add(mail) //recipent email
    //..ccRecipients.addAll(['destCc1@example.com', 'destCc2@example.com']) //cc Recipents emails
    //..bccRecipients.add(Address('bccAddress@example.com')) //bcc Recipents emails
      ..subject =
          'Easy Rescuer Doğrulama Linkiniz : ${DateTime.now()}' //subject of the email
    //..text =
...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #000;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #2f3433;font-size: 40px;line-height: 47px;font-family: Oswald,Avenir Next Condensed,Arial Narrow,MS UI Gothic,sans-serif;text-align: center;"><span style="color:#ffffff">${isim.toUpperCase()} ${soyisim.toUpperCase()} seni korumaya geldik.</span></h1><p style="Margin-top: 20px;Margin-bottom: 20px;text-align: center;"><span style="color:#faf0fa">Bu uygulamaya kayıt olduğunuzda&nbsp;tehlike veya doğal afet durumlarında iletişiminiz kesilmeyecek.</span></p>
      </div>
    </div>
      ...
      <div style="mso-line-height-rule: exactly;line-height: 297px;font-size: 1px;">&nbsp;</div>
              ...
              <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <p class="size-30" style="Margin-top: 0;Margin-bottom: 20px;font-family: arial,sans-serif;font-size: 26px;line-height: 34px;text-align: center;" lang="x-size-30"><span class="font-arial"><strong><span style="color:#ffffff">HESABINIZI DOĞRULAMAK İÇİN&nbsp; TIKLAYINIZ</span></strong></span></p>
      </div>
    </div>
            
              <div style="Margin-left: 20px;Margin-right: 20px;">
      <div class="btn fullwidth btn--shadow btn--large" style="Margin-bottom: 20px;text-align: center;">
        <!--[if !mso]--><a style="border-radius: 4px;display: block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px 13px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;box-shadow: inset 0 -2px 0 0 rgba(0, 0, 0, 0.2);background-color: #cc5040;font-family: Arial, sans-serif;" href="$urlDogrula">HESABI DOĞRULA</a><!--[endif]-->
      ...
      <div style="mso-line-height-rule: exactly;line-height: 43px;font-size: 1px;">&nbsp;</div>
              ...
              <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #2f3433;font-size: 22px;line-height: 31px;font-family: Oswald,Avenir Next Condensed,Arial Narrow,MS UI Gothic,sans-serif;text-align: center;">Kayıt olduğunuz için teşekkür ederiz.</h2><p style="Margin-top: 16px;Margin-bottom: 20px;text-align: center;">Bu uygulama sizi tehlike anlarında koruma görevi üstlenecektir.</p>
      </div>
    </div>
    ...
    try {
      ...
      myToast("E-postanıza doğrulama linki gönderildi.");
      print('Message sent: ' +
